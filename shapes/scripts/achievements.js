...
var totalScore = Number(localStorage['shapesTotalScore']);
var oldAchievements = JSON.parse(localStorage['shapesAchievements']);
...
function addAchievement(level) {
    ...
    localStorage['shapesAchievements'] = JSON.stringify(newAchievements);
}
